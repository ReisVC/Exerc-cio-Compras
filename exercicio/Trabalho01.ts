...
import { Enlatados } from "./Classes/Enlatados";
import { Bebidas } from "./Classes/Bebidas";
import { Biscoito } from "./Classes/Biscoito";

import { Dinheiro } from './Classes/Dinheiro';
import { Cartão } from './Classes/Cartão';
...
let senha:number = Number(readlineSync.question('Qual sua senha?  '))
